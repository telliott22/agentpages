export default function DocsPage() {
  const endpoints = [
    ...
    },
    {
      ...
      desc: "AgentPages' own A2A agent card. AgentPages itself is an A2A agent — you can discover it just like any other agent.",
    },
    {
      method: 'POST', path: '/api/a2a',
      desc: 'A2A JSON-RPC endpoint. Other agents can query AgentPages to discover agents using the standard A2A message/send method.',
    ...
    <div className="max-w-3xl">
      ...
      <div className="mt-12 border border-blue-500/20 rounded-xl p-6 bg-blue-500/5">
        ...
        <p className="text-sm text-gray-400 mb-4">
          The Agent-to-Agent (A2A) protocol is an open standard by Google enabling AI agents to discover and communicate with each other regardless of framework. AgentPages is an independent directory built on this protocol.
        </p>
